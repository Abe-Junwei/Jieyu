...
export function createBackgroundMemoryRuntime(
  ...
  getContextRef: {
    current: (() => { shortTerm?: { workspaceTextId?: string } | null } | null) | undefined;
  },
  ...
  return createAiChatBackgroundMemoryRuntime({
    ...
    flushQuotaMaxCompletedWriteFlushesPerConversation:
      featureFlags.aiBackgroundMemorySessionWriteQuotaMax,
