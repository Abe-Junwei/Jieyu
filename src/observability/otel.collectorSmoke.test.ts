...
describe('otel collector smoke', () => {
  ...
  let providerRef: { forceFlush?: () => Promise<void>; shutdown?: () => Promise<void> } | null =
    null;
  ...
  itIfOtelSmoke(
    'exports contract payload to local collector',
    async () => {
      ...
      class CapturingOTLPTraceExporter {
        ...
        forceFlush(
          ...args: Parameters<
            NonNullable<InstanceType<typeof otlp.OTLPTraceExporter>['forceFlush']>
          >
        ) {
