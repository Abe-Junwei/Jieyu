...
export const M5_METRIC_CATALOG: ReadonlyArray<MetricDefinition> = [
  ...
  },
  {
    ...
    kind: 'counter',
    unit: 'count',
    description: 'Count of parent fallback owner resolution attempts on read paths.',
  },
  {
  ...
  {
    id: 'ai.trace.otel_bootstrap_failure_count',
    category: 'ai',
  ...
  },
  {
    ...
    kind: 'counter',
    unit: 'count',
    description: 'Count of OTel bootstrap circuit-open events after consecutive failures.',
  },
  {
    id: 'ai.trace.otel_export_failure_count',
    category: 'ai',
    module: 'otel-bootstrap',
    kind: 'counter',
    unit: 'count',
    description: 'Count of OTel exporter failures returned by export callback.',
  },
  {
    id: 'ai.trace.otel_circuit_short_circuit_count',
    category: 'ai',
    module: 'otel-bootstrap',
    kind: 'counter',
    unit: 'count',
    description: 'Count of OTel exports skipped while circuit breaker remains open.',
  },
] as const;
