...
const ACTION_LABEL_KEYS: Record<ActionId, DictKey> = {
  ...
  toolbarReviewPresetManualAttention:
    'transcription.voiceAction.toolbarReviewPresetManualAttention',
  ...
  toolbarExportSrt: 'transcription.voiceAction.toolbarExportSrt',
  ...
  toolbarPreviewProjectArchiveImport:
    'transcription.voiceAction.toolbarPreviewProjectArchiveImport',
  ...
  toolbarTimeMappingFormHistorySelect:
    'transcription.voiceAction.toolbarTimeMappingFormHistorySelect',
  ...
  workspaceObserverRecommendationExecute:
    'transcription.voiceAction.workspaceObserverRecommendationExecute',
