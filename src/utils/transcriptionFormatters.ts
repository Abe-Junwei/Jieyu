...
/**
 * Language key that `pickDefaultTranscriptionText` reads.
 * Non-empty `default` wins; otherwise the first non-empty value key.
 * An empty record writes back to `default`.
 */
