...
const WORKSPACE_DEFAULT_ZOOM_MODE_STORAGE_KEY = 'jieyu:workspace-default-zoom-mode';
const WORKSPACE_AUTO_SCROLL_STORAGE_KEY = 'jieyu:workspace-auto-scroll-enabled';
const WORKSPACE_SNAP_STORAGE_KEY = 'jieyu:workspace-snap-enabled';
