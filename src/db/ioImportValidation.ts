...
const validatorByCollection = {
  ...
  token_lexeme_links: (value: unknown) => validateTokenLexemeLinkDoc(value as TokenLexemeLinkDocType),
  ...
  language_display_names: (value: unknown) => validateLanguageDisplayNameDoc(value as LanguageDisplayNameDocType),
  language_aliases: (value: unknown) => validateLanguageAliasDoc(value as LanguageAliasDocType),
  language_catalog_history: (value: unknown) => validateLanguageCatalogHistoryDoc(value as LanguageCatalogHistoryDocType),
  custom_field_definitions: (value: unknown) => validateCustomFieldDefinitionDoc(value as CustomFieldDefinitionDocType),
  ...
  orthography_bridges: (value: unknown) => validateOrthographyBridgeDoc(value as OrthographyBridgeDocType),
  orthography_transforms: (value: unknown) => validateOrthographyBridgeDoc(value as OrthographyBridgeDocType),
  locations: (value: unknown) => validateLocationDoc(value as LocationDocType),
  bibliographic_sources: (value: unknown) => validateBibliographicSourceDoc(value as BibliographicSourceDocType),
  ...
  structural_rule_profiles: (value: unknown) => validateStructuralRuleProfileAssetDoc(value as StructuralRuleProfileAssetDocType),
  ...
  layer_unit_contents: (value: unknown) => validateLayerUnitContentDoc(value as LayerUnitContentDocType),
  ...
  segment_quality_snapshots: (value: unknown) => validateSegmentQualitySnapshotDoc(value as SegmentQualitySnapshotDocType),
  scope_stats_snapshots: (value: unknown) => validateScopeStatsSnapshotDoc(value as ScopeStatsSnapshotDocType),
  speaker_profile_snapshots: (value: unknown) => validateSpeakerProfileSnapshotDoc(value as SpeakerProfileSnapshotDocType),
  translation_status_snapshots: (value: unknown) => validateTranslationStatusSnapshotDoc(value as TranslationStatusSnapshotDocType),
