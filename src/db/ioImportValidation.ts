...
const validatorByCollection = {
  ...
  lexeme_assets: (value: unknown) => validateLexemeAssetDoc(value as LexemeAssetDocType),
  lexeme_asset_links: (value: unknown) =>
    validateLexemeAssetLinkDoc(value as LexemeAssetLinkDocType),
