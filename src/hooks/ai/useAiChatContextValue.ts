...
export function pickAiChatContextValue(P: AiChatContextSource): AiChatContextValue {
  ...
  return {
    ...
    ...(P.timelineReadModelEpoch !== undefined
      ? { timelineReadModelEpoch: P.timelineReadModelEpoch }
      : {}),
    ...(P.adoptionItemsPushSinkRef !== undefined
      ? { adoptionItemsPushSinkRef: P.adoptionItemsPushSinkRef }
      : {}),
  };
}
