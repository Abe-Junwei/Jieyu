...
import type {
  BackgroundToolSandboxAction,
  BackgroundToolSandboxReason,
} from '../../ai/sandbox/backgroundToolSandbox';
...
export function scheduleSessionSidecarSandboxAudit(options: {
  ...
  const { conversationId, virtualWritePath, sandboxAction, sandboxReason, sourceMessageId } =
    options;
