...
function makeTimelineUnit(
  overrides: Partial<TimelineUnitView> &
    Pick<TimelineUnitView, 'id' | 'startTime' | 'endTime' | 'kind'>,
): TimelineUnitView {
  return {
    mediaId: 'media-1',
    layerId: 'layer-1',
    ...
    renderHook(() => {
      ...
      return useKeybindingActions({
        player: {
          ...
          playbackRate: 1,
          instanceRef: {
            current: { getCurrentTime: () => 0 } as unknown as import('wavesurfer.js').default,
          },
          stop: vi.fn(),
          playRegion: vi.fn(),
    ...
    const { result } = renderHook(() => {
      ...
      return useKeybindingActions({
        player: {
          ...
          playbackRate: 1,
          instanceRef: {
            current: { getCurrentTime: () => 1.25 } as unknown as import('wavesurfer.js').default,
          },
          stop: vi.fn(),
          playRegion: vi.fn(),
          togglePlayback: vi.fn(),
    ...
    const { result } = renderHook(() => {
      ...
      return useKeybindingActions({
        player: {
          ...
          playbackRate: 1,
          instanceRef: {
            current: { getCurrentTime: () => 2.4 } as unknown as import('wavesurfer.js').default,
          },
          stop: vi.fn(),
          playRegion: vi.fn(),
          togglePlayback: vi.fn(),
