...
import { getAssistantDialogueSnapshot, isAssistantChatComposerBlocked } from '../services/assistantDialogueState';

export function isAiChatSendBlockedByAssistantDialogue(pendingToolCall: PendingAiToolCall | null): boolean {
