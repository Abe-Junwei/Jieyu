...
import type { VoiceInputService as VoiceInputServiceType } from '../services/VoiceInputService';
...
import type { CommercialProviderCreateConfig, SttEnhancementReachability } from '../services/stt';
