...
describe('useDialogs', () => {
  it('preserves time mapping history from text metadata', async () => {
    ...
    vi.spyOn(LinguisticService.timeline, 'getTextById').mockResolvedValue(textDoc);
    vi.spyOn(LinguisticService.timeline, 'listTexts').mockResolvedValue([textDoc] as never);
