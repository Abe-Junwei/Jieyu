...
let voiceIntentRefineRuntimePromise: Promise<
  typeof import('../../services/voiceIntentRefine')
> | null = null;
let voiceSessionStoreRuntime: typeof import('../../services/VoiceSessionStore') | null = null;
let voiceSessionStoreRuntimePromise: Promise<
  typeof import('../../services/VoiceSessionStore')
> | null = null;
