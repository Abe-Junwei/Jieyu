...
function MissingProviderProbe() {
  capturedContext = useSidePaneLayerContextOrFallback({ warnOnMissing: true });
  return null;
}

function ProviderProbe() {
  const ctx = useSidePaneLayerContextOrFallback({ warnOnMissing: false });
  return (
    <div>
...
describe('SidePaneLayerContext', () => {
  ...
  it('returns provider value when SidePaneLayerProvider is present', () => {
