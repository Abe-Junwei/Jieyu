...
type DeferredAiChatState = {
  ...
  conversationManagement: UseTranscriptionAiControllerResult['aiChat']['conversationManagement'];
};
  ...
  const runtimeState = useMemo<DeferredTranscriptionAiRuntimeState>(
    () => ({
      aiChat: {
        ...
        conversationManagement: aiChat.conversationManagement,
      },
      aiToolDecisionLogs,
      aiVerticalWorkflowAuditEntries,
      executeVoiceToolCall,
