                ...
                <>
                  ...
                  >
                    <dl className="lexicon-workspace-detail-grid">
                      ...
                      <div>
                        <dt>{t(locale, 'workspace.lexicon.restrictionsLabel')}</dt>
                        <dd data-testid="lexicon-workspace-restrictions">
                          {selectedLexeme.restrictions ?? t(locale, 'workspace.lexicon.notSet')}
                        </dd>
                      </div>
                      <div>
