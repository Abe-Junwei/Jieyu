    ...
    >
      ...
      {draft ? (
        <div className="orthography-workspace-form-stack">
          {/* ── Tier 0 · 身份信息（主区域，无包装） | Identity — dominant region ── */}
          ...
          <section className="orthography-workspace-subsection">
            ...
            <div className="orthography-workspace-form-grid">
              <label className="dialog-field">
                ...
                <input className="input" type="text" value={draft.primaryFonts} onChange={(event) => onDraftChange('primaryFonts', event.target.value)} placeholder={builderMessages.primaryFontPlaceholder} />
              </label>
              <label className="dialog-field">
                <span>{builderMessages.fallbackFontLabel}</span>
                <input className="input" type="text" value={draft.fallbackFonts} onChange={(event) => onDraftChange('fallbackFonts', event.target.value)} placeholder={builderMessages.fallbackFontPlaceholder} />
              </label>
              <label className="dialog-field">
                <span>{t(locale, 'workspace.orthography.monoFontLabel')}</span>
                <input className="input" type="text" value={draft.monoFonts} onChange={(event) => onDraftChange('monoFonts', event.target.value)} placeholder={builderMessages.fallbackFontPlaceholder} />
              </label>
              <label className="dialog-field">
            ...
            <div className="orthography-workspace-checkbox-row">
          ...
          <section className="orthography-workspace-subsection">
            ...
            <hr className="orthography-workspace-divider" />
            ...
            <div className="orthography-workspace-form-grid">
              ...
              <label className="dialog-field">
                ...
                <input className="input" type="text" value={draft.exemplarNumbers} onChange={(event) => onDraftChange('exemplarNumbers', event.target.value)} placeholder={builderMessages.exemplarPlaceholder} />
              </label>
              <label className="dialog-field">
                <span>{t(locale, 'workspace.orthography.punctuationExemplarLabel')}</span>
                <input className="input" type="text" value={draft.exemplarPunctuation} onChange={(event) => onDraftChange('exemplarPunctuation', event.target.value)} placeholder={builderMessages.exemplarPlaceholder} />
              </label>
              <label className="dialog-field">
                <span>{t(locale, 'workspace.orthography.indexExemplarLabel')}</span>
                <input className="input" type="text" value={draft.exemplarIndex} onChange={(event) => onDraftChange('exemplarIndex', event.target.value)} placeholder={builderMessages.exemplarPlaceholder} />
              </label>
            </div>
          </section>

          {/* ── Tier 3 · 高级设置 | Advanced ── */}
          <details className="orthography-workspace-advanced">
            <summary className="orthography-workspace-advanced-summary">
              <span>{t(locale, 'workspace.orthography.sectionAdvancedTitle')}</span>
              <span className="orthography-workspace-advanced-meta">
            ...
            <div className="orthography-workspace-advanced-body">
              {/* 编目 | Catalog */}
              <div className="orthography-workspace-form-grid">
                <label className="dialog-field">
