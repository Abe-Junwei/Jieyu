...
import type { UseTranscriptionSpeakerControllerInput } from './useTranscriptionSpeakerController.types';

export type { UseTranscriptionSpeakerControllerInput } from './useTranscriptionSpeakerController.types';
