...
export function getAiChatHybridMessages(isZh: boolean): AiChatHybridMessages {
  ...
  if (isZh) {
    return {
      ...
      recommendationButtonLabel: (label) =>
        tf(locale, 'ai.chat.hybrid.recommendationButton', { label }),
