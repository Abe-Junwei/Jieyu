...
const DEFAULT_LAYER_ACTION_POPOVER_CATALOG: LayerActionPopoverCatalog = {
  ...
  dependentConstraint: 'Dependent boundary (segment boundaries follow the selected host transcription layer)',
  independentConstraint: 'Independent boundary (segment boundaries are defined independently on this layer)',
