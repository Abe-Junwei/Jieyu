...
const zhCN: ProjectSetupDialogMessages = {
  ...
  orthographyDefaultInference: '\u6cbf\u7528\u9ed8\u8ba4\u811a\u672c\u63a8\u65ad',
  createOrthography: '+ \u65b0\u5efa\u6b63\u5b57\u6cd5\u2026',
  noOrthographyHint: '\u5f53\u524d\u8bed\u8a00\u6682\u65e0\u6b63\u5b57\u6cd5\u8bb0\u5f55\uff0c\u53ef\u76f4\u63a5\u65b0\u5efa\u6216\u6cbf\u7528\u9ed8\u8ba4\u811a\u672c\u63a8\u65ad\u3002',
  cancel: '\u53d6\u6d88',
  creating: '\u521b\u5efa\u4e2d...',
  createProject: '\u521b\u5efa\u9879\u76ee',
...
const enUS: ProjectSetupDialogMessages = {
  ...
  orthographyDefaultInference: 'Use default script inference',
  createOrthography: '+ New orthography\u2026',
  noOrthographyHint: 'No orthography is recorded for this language yet. You can create one or rely on default script inference.',
  cancel: 'Cancel',
  creating: 'Creating...',
