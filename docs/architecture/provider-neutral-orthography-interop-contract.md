---
title: Provider-Neutral Orthography Interop Contract
doc_type: architecture-contract
status: active
owner: repo
last_reviewed: 2026-04-06
source_of_truth: compatibility-contract
---

# Provider-Neutral Orthography Interop Contract

> 文档角色：长期有效的兼容性合同文档。最后更新：2026-03-31。
