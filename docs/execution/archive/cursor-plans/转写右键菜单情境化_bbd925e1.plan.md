...
[`src/pages/TranscriptionPage.TimelineContent.tsx`](src/pages/TranscriptionPage.TimelineContent.tsx) 对每个 [`TimelineLaneHeader`](src/components/TimelineLaneHeader.tsx) 传入**相同**的：
...
在 [`TranscriptionTimelineTextOnly.tsx`](src/pages/TranscriptionPage.TimelineContent.tsx) 渲染 `TimelineLaneHeader` 时：
...
- 层头挂载轨/说话人：[`src/pages/TranscriptionPage.TimelineContent.tsx`](src/pages/TranscriptionPage.TimelineContent.tsx) 约 659–691 行；层头菜单定义：[`src/components/TimelineLaneHeader.tsx`](src/components/TimelineLaneHeader.tsx) 约 305–464 行。
