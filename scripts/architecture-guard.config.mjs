...
export const architectureGuardRules = [
  ...
  patternRule(/^src\/pages\/(?!.*\.test\.).*\.(ts|tsx)$/, {
    ...
    excludeFiles: [
      ...
      'src/pages/TranscriptionPage.runtimeContracts.ts',
      'src/pages/TranscriptionPage.runtimeProps.ts',
      'src/pages/transcriptionExportCallbacks.ts',
      'src/pages/transcriptionReadyWorkspaceBatchOpsSectionBuilder.ts',
      ...
      'src/pages/transcriptionReadyWorkspaceObserverPropsBuilder.ts',
      'src/pages/transcriptionReadyWorkspaceProjectHubPropsBuilder.ts',
      'src/pages/transcriptionReadyWorkspacePropsBuilders.ts',
      'src/pages/transcriptionReadyWorkspaceRecoveryBannerPropsBuilder.ts',
      ...
      'src/pages/useReadyWorkspaceAxisStatus.ts',
      'src/pages/useSpeakerActionRoutingController.ts',
      'src/pages/useTrackEntityPersistenceController.ts',
      'src/pages/useTrackEntityStateController.ts',
