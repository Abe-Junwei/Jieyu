...
export const architectureGuardRules = [
  ...
  // ── ReadyWorkspace: 承载全部运行时 hook 与 JSX | Runtime workspace with all hooks ──
  {
    ...
    requiredRegexes: [
      ...
      /(?:useTranscriptionTimelineController\(\{|useReadyWorkspaceTextEditingController\()/,
      /(?:useTranscriptionTimelineInteractionController\(\{|useReadyWorkspaceTimelineSyncController\()/,
